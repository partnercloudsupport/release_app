...
enum CashLogoStyle {
  ...
  ///
  /// This is the default behavior for [CashLogoDecoration] objects.
  markOnly,
...
class CashLogoDecoration extends Decoration {
  ...
  /// be null.
  const CashLogoDecoration({
    this.lightColor: const Color(0xFF42A5F5), // Colors.blue[400]
    this.darkColor: const Color(0xFF0D47A1), // Colors.blue[900]
    this.textColor: const Color(0xFF616161),
    this.style: CashLogoStyle.markOnly,
    this.margin: EdgeInsets.zero,
  }) : _position = style == CashLogoStyle.markOnly ? 0.0 : style == CashLogoStyle.horizontal ? 1.0 : -1.0, // ignore: CONST_EVAL_TYPE_BOOL_NUM_STRING
       // (see https://github.com/dart-lang/sdk/issues/26980 for details about that ignore statement)
       _opacity = 1.0;

  const CashLogoDecoration._(this.lightColor, this.darkColor, this.textColor, this.style, this._position, this._opacity, this.margin);
  ...
  /// [CashLogoStyle.horizontal] or [CashLogoStyle.stacked]. The
  ...
  static CashLogoDecoration lerp(CashLogoDecoration a, CashLogoDecoration b, double t) {
    assert(a == null || a.debugAssertIsValid());
    assert(b == null || b.debugAssertIsValid());
    if (a == null && b == null)
      return null;
    if (a == null) {
      return new CashLogoDecoration._(
        b.lightColor,
        b.darkColor,
        b.textColor,
        b.style,
  ...
  @override
  CashLogoDecoration lerpFrom(Decoration a, double t) {
    assert(debugAssertIsValid());
    if (a is! CashLogoDecoration)
  ...
  @override
  CashLogoDecoration lerpTo(Decoration b, double t) {
    assert(debugAssertIsValid());
    if (b is! CashLogoDecoration)
  ...
  bool operator ==(dynamic other) {
    ...
    if (identical(this, other))
      return true;
    if (other is! CashLogoDecoration)
      return false;
    final CashLogoDecoration typedOther = other;
...
class _FlutterLogoPainter extends BoxPainter {
  ...
  final CashLogoDecoration _config;
